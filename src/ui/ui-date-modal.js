...
export function DateModal({
  ...
  const [, setIsPlaceCollapsed] = React.useState(true);
  ...
  const [, setHasInteracted] = React.useState(false);
        ...
        selectedPlace && /*#__PURE__*/React.createElement("div", {
          ...
          duplicatePlace && /*#__PURE__*/React.createElement("div", {
            ...
            /*#__PURE__*/React.createElement("div", { style: { display: 'flex', gap: '6px', marginTop: '7px' } },
              /*#__PURE__*/React.createElement("button", { type: 'button', onClick: () => setSelectedPlace(prev => ({ ...prev, mergeTargetId: duplicatePlace.id })), style: { border: 0, borderRadius: 'var(--radius-sm)', padding: '5px 10px', background: 'var(--accent-primary)', color: 'var(--on-brand, #fff)', fontSize: 'var(--font-size-sm)', fontWeight: 700, cursor: 'pointer' } }, '병합'),
