 ...
 */
/**
 * Builds the 기록 tab's real ingredients (WP-06 continuation, 장소 subtab). Straight pass-through
 * of the same values/handlers `app-main.js`'s own `activeView === 'places'` render block already
 * uses.
 */
