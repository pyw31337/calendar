...
## P6-57 (2026-08-21)
- 다크: 유튜브/링크 미리보기 테두리, 사이드메뉴 배경, 마감됨 뱃지, 정산 막대 트랙
- 갤러리/장소 섹션 타이틀·아이콘을 채팅·투표와 동일한 #2563EB

## P6-58 (2026-08-21)
- 다크: 사이드/모달/시트 DIM #0f172acc
- 사이드 아이콘 흰 배경 → #1B2540
- 설정 라벨(다크모드·글자크기·채팅알림) 밝게
- 글자크기 ± 원형 버튼 중앙 정렬

## P6-59 (2026-08-21)
- 채팅/메인 사이드메뉴 구분선 #E2E8F0 → var(--border-subtle)
- 다크에서 사이드메뉴 --border-subtle #232F49 강제
- 기타 하드코딩 구분선 토큰화 점검

## P6-60 (2026-08-21)
- .modal-overlay 좌우 패딩 제거 (상하만 유지)

## P6-61 (2026-08-21)
- 모바일(≤480px): 일정모달 입력+버튼 세로 스택 (참석메모/장소검색/장소메모/정산금액)
- 추가·취소/수정 버튼 하단 전폭
- 참석 명단 메모 영역 가로 활용 확대

## P6-62 (2026-08-21)
- 모바일 .modal-container 좌우 padding/margin 제거
...
## P6-68 (2026-08-21)
- 모바일 모달 세로: 72svh 및 100svh-100px 보수 상한 (주소창/하단메뉴 여유)
- visualViewport도 min(72%, height-100) 적용
...
## P6-69 (2026-08-21)
- 닫기확인 등 confirm 모달: 좌우 패딩 20px 복구 (취소/확인 버튼 여백)
- 일정 모달 등 header/form 구조만 셸 좌우 0 유지 (헤더 패딩 추가 없음)
